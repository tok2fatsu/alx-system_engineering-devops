...
+ The role of the domain name.<br/>To provide a human-friendly alias for an IP Address. For example, the domain name `www.google.com` is easier to recognize and remember than `142.250.181.164`. The IP address and domain name alias is mapped in the Domain Name System (DNS)
